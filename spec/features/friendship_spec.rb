...
RSpec.feature 'Friendships', type: :feature do
  scenario 'invite to friendship' do
    @user = User.new(name: 'User', email: 'user@email.com', password: '123123123', password_confirmation: '123123123')
    @user.save
    @friend = User.new(name: 'Friend', email: 'friend@email.com', password: '123123123', password_confirmation: '123123123')
    @friend.save
    visit 'users/sign_in'
  ...
  scenario 'accept friendship' do
    ...
    expect(page).to have_text('Friendship was accepted')
  end
end